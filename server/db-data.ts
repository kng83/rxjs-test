export const COURSES: any = {
  ...
  2: {
    ...
    longDescription: "Learn Web Security Fundamentals and apply them" +
      " to defend an Angular / Node Application from multiple types of attacks.",
  ...
  5: {
    ...
    longDescription: "Learn Advanced Angular functiona" +
      "lity typically used in Library Development. Advanced Components, Directives, Testing, Npm",
  ...
  7: {
    ...
    longDescription: "Learn the core RxJs Observable Pattern as we" +
      "ll and many other Design Patterns for building Reactive Angular Applications.",
